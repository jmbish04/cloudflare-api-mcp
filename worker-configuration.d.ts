/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=./wrangler.jsonc` (hash: 360dc1dfce458eff8befb0ee79ffdb17)
// Runtime types generated with workerd@1.20260811.1 2026-01-12 nodejs_compat
interface __BaseEnv_Env {
	SESSION: KVNamespace;
	OAUTH_KV: KVNamespace;
	CICD_DB: D1Database;
	CLOUDFLARE_USER_WRANGLER_API_TOKEN: SecretsStoreSecret;
	GH_TOKEN: SecretsStoreSecret;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "UPSTREAM_MCP_URL">> {}
}
